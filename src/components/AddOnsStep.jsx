...
// //   const addOns = [
// //     { name: "Online service", description: "Access to multiplayer games", price: "+$1/mo" },
// //     { name: "Larger storage", description: "Extra 1TB of cloud save", price: "+$2/mo" },
// //     { name: "Customizable profile", description: "Custom theme on your profile", price: "+$2/mo" },
// //   ];
...
// //         <p className="text-sm sm:text-base">Add-ons help to enhance your gameing experience. </p>
// //       </div>
